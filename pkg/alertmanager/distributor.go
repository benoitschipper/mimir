...
func (d *Distributor) doQuorum(userID string, w http.ResponseWriter, r *http.Request, logger log.Logger, m merger.Merger) {
	...
	err = ring.DoBatchWithOptions(r.Context(), RingOp, ring.NewReadRingBatchAdapter(d.alertmanagerRing), []uint32{shardByUser(userID)}, func(am ring.InstanceDesc, _ []int) error {
