...
//go:build !stringlabels && !internlabels
...
// Symbol-table is no-op, just for api parity with internlabels.
...
// NewBuilderWithSymbolTable creates a Builder, for api parity with internlabels.
func NewBuilderWithSymbolTable(_ *SymbolTable) *Builder {
	return NewBuilder(EmptyLabels())
}

// NewScratchBuilderWithSymbolTable creates a ScratchBuilder, for api parity with internlabels.
