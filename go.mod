...
require (
	...
	github.com/prometheus/alertmanager v0.26.1-0.20240105135819-ab2248afa7e5
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20231220125736-12d2c1038b96
